...
export default function DatenschutzPage() {
  return (
    <BaseSection background="transparent">
      <HiddenHeadline
        text="Datenschutzerklärung – Verosoma"
        id="Verosoma-Datenschutzerklaerung-heading"
      />
      <TextSection id="datenschutz" title="Datenschutzerklärung" description="Datenschutz hat einen hohen Stellenwert für uns.">
        <Headline level="h2" size="lg" variant="light-default">Datenschutzerklärung</Headline>

        <Headline level="h2" size="md" variant="light-default">1. Datenschutz auf einen Blick</Headline>

        <Headline level="h3" size="sm" variant="light-default">Allgemeine Hinweise</Headline>
        ...
        <Headline level="h2" size="md" variant="light-default">Datenerfassung auf dieser Website</Headline>
        <Headline level="h3" size="sm" variant="light-default">Wer ist verantwortlich für die Datenerfassung auf dieser Website?</Headline>
        <Text variant="light-default">
        ...
        <Headline level="h4" size="sm" variant="light-default">Wie erfassen wir Ihre Daten?</Headline>
        <Text variant="light-default">
        ...
        <Headline level="h4" size="sm" variant="light-default">Wofür nutzen wir Ihre Daten?</Headline>
        <Text variant="light-default">
        ...
        <Headline level="h4" size="sm" variant="light-default">Welche Rechte haben Sie bezüglich Ihrer Daten?</Headline>
        <Text variant="light-default">
        ...
        <Headline level="h3" size="sm" variant="light-default">Analyse-Tools und Tools von Drittanbietern</Headline>
        <Text variant="light-default">
        ...
        <Headline level="h2" size="sm" variant="light-default">2. Hosting</Headline>
        <Text variant="light-default">Wir hosten die Inhalte unserer Website bei folgendem Anbieter:</Text>

        <Headline level="h3" size="sm" variant="light-default">Externes Hosting</Headline>
        <Text variant="light-default">
        ...
        <Text variant="light-default">
          ...
          Device-Fingerprinting) umfasst. Die Einwilligung ist jederzeit widerrufbar.
        </Text>
        <Text variant="light-default">
        ...
        <Headline level="h4" size="sm" variant="light-default">Auftragsverarbeitung</Headline>
        <Text variant="light-default">
        ...
        <Headline level="h2" size="sm" variant="light-default">3. Allgemeine Hinweise und Pflichtinformationen</Headline>
        <Headline level="h3" size="sm" variant="light-default">Datenschutz</Headline>
        <Text variant="light-default">
        ...
        <Text variant="light-default">
          ...
          >
            https://www.e-recht24.de
              ...
              <Headline level="h2" size="sm" variant="light-default">4. Datenerfassung auf dieser Website</Headline>

        <Headline level="h3" size="sm" variant="light-default">Cookies</Headline>
        <Text variant="light-default">
        ...
        <Text variant="light-default">
          ...
          würden (z.&nbsp;B. Warenkorb- oder Video-Funktionen). Andere Cookies können
        ...
        <Text variant="light-default">
          ...
          zur Bereitstellung bestimmter, von Ihnen gewünschter Funktionen oder zur
          Optimierung der Website erforderlich sind (notwendige Cookies), werden auf
          ...
          Grundlage dieser Einwilligung (Art. 6 Abs. 1 lit. a DSGVO und § 25 Abs. 1
        ...
        <Headline level="h3" size="sm" variant="light-default">Server-Log-Dateien</Headline>
        <Text variant="light-default">
        ...
        <Text variant="light-default">
          ...
          an der technisch fehlerfreien Darstellung und Optimierung seiner Website –
          hierzu müssen die Server-Log-Files erfasst werden.
        </Text>

        <Headline level="h3" size="sm" variant="light-default">Kontaktformular</Headline>
        <Text variant="light-default">
        ...
        <Text variant="light-default">
          ...
          Ihrer Einwilligung (Art. 6 Abs. 1 lit. a DSGVO), sofern diese abgefragt
          wurde; die Einwilligung ist jederzeit widerrufbar.
        </Text>

        <Headline level="h3" size="sm" variant="light-default">Anfrage per E-Mail, Telefon oder Telefax</Headline>
        <Text variant="light-default">
        ...
        <Headline level="h3" size="sm" variant="light-default">Kommentar-Funktion</Headline>
        <Text variant="light-default">
          Für die Kommentarfunktion werden neben Ihrem Kommentar auch Angaben zum
          Zeitpunkt der Erstellung des Kommentars, Ihre E-Mail-Adresse und – wenn Sie
          nicht anonym posten – Ihr Nutzername gespeichert.
        </Text>

        <Headline level="h4" size="sm" variant="light-default">Speicherung der IP-Adresse</Headline>
        <Text variant="light-default">
          ...
          Rechtsverletzungen (z.&nbsp;B. Beleidigungen oder Propaganda) gegen den
          Verfasser vorgehen zu können.
        </Text>

        <Headline level="h4" size="sm" variant="light-default">Speicherdauer der Kommentare</Headline>
        <Text variant="light-default">
        ...
        <Headline level="h4" size="sm" variant="light-default">Rechtsgrundlage</Headline>
        <Text variant="light-default">
        ...
        <Headline level="h3" size="sm" variant="light-default">Gravatar</Headline>
        <Text variant="light-default">
          Wir haben Gravatar auf dieser Website eingebunden. Anbieter ist die
          Automattic Inc., 60 29th Street #343, San Francisco, CA 94110, USA. Gravatar
          ist ein Tool, das es ermöglicht, persönliche Avatare für Nutzer
          bereitzustellen. Wenn Sie auf unserer Website kommentieren und Gravatar
          aktiviert ist, wird der Hash Ihrer E-Mail-Adresse von Gravatar verarbeitet.
        </Text>
        <Text variant="light-default">
          Die Verwendung von Gravatar erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO.
          Der Websitebetreiber hat ein berechtigtes Interesse an einer ansprechenden
          Darstellung seiner Foren. Sofern eine Einwilligung abgefragt wurde, erfolgt
        ...
        <Headline level="h2" size="sm" variant="light-default">5. Newsletter</Headline>
        <Headline level="h3" size="sm" variant="light-default">Newsletter-Daten</Headline>
        <Text variant="light-default">
          Wenn Sie den auf der Website angebotenen Newsletter beziehen möchten,
          benötigen wir von Ihnen eine E-Mail-Adresse sowie Informationen, die uns
          ...
          Weitere Daten werden nicht bzw. nur freiwillig erhoben.
        </Text>
        <Text variant="light-default">
        ...
        <Headline level="h2" size="sm" variant="light-default">6. Plugins und Tools</Headline>
        <Headline level="h3" size="sm" variant="light-default">Google Fonts (lokales Hosting)</Headline>
        <Text variant="light-default">
          Diese Seite nutzt zur einheitlichen Darstellung von Schriftarten sogenannte
          Google Fonts, die von Google bereitgestellt werden. Die Fonts sind lokal
          installiert; eine Verbindung zu Google-Servern findet dabei nicht statt.
        </Text>
        <Text variant="light-default">
